...
Esta política es obligatoria para todo colaborador que tenga acceso a inventarios o participe en actividades relacionadas con la recepción, almacenamiento, preparación, venta o disposición de productos.
...
Los productos con fecha más próxima de vencimiento deberán utilizarse primero.

La falta de rotación adecuada podrá considerarse incumplimiento operativo.
...
Queda prohibido utilizar la figura de merma para justificar consumos no autorizados.
...
No constituyen mermas cuando formen parte de estrategias comerciales o de capacitación autorizadas.
