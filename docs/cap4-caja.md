...
Esta política es de cumplimiento obligatorio para todo colaborador que tenga acceso directo o indirecto a cajas, terminales de cobro o valores de la empresa.
...
La empresa podrá realizar investigaciones internas cuando existan elementos que lo justifiquen.
...
La empresa no podrá apropiarse de las propinas ni utilizarlas para compensar pérdidas operativas.

Cuando exista un sistema de distribución colectiva, éste deberá comunicarse de forma clara a todo el personal.
...
La empresa podrá solicitar que mochilas, carteras u objetos personales permanezcan en las áreas designadas para ello durante la jornada laboral.
...
Su divulgación no autorizada podrá dar lugar a medidas disciplinarias.
...
1. **Recepción del fondo.** El responsable del turno recibe el fondo de caja asignado.
2. **Conteo inicial.** Cuenta el fondo por denominación y verifica que coincida con el monto autorizado. Cualquier diferencia se reporta de inmediato antes de iniciar ventas.
3. **Registro de apertura.** Deja constancia del monto inicial conforme a los procedimientos internos.

### Operación durante el turno

4. **Cobro.** Toda venta se registra en el sistema autorizado antes de entregar el producto (ver apartado 4).
5. **Manejo de propinas.** Las propinas se depositan en el recipiente designado y se mantienen separadas del fondo de caja y de las ventas (ver apartado 12).
6. **Arqueo parcial.** Cuando la empresa lo indique, se realiza un arqueo intermedio para verificar que el efectivo corresponda a las ventas registradas.

### Cierre y entrega

7. **Corte de turno.** Al finalizar, se cuenta el efectivo, se verifican las terminales y los depósitos, y se comparan contra lo registrado en el sistema.
8. **Registro de diferencias.** Todo faltante o sobrante se documenta conforme al apartado 11.
9. **Entrega-recepción.** Cuando hay relevo de turno, el fondo y las observaciones se entregan al siguiente responsable, quien verifica el conteo antes de aceptar la caja.
10. **Cierre final.** Al cierre del establecimiento se resguarda el efectivo y se deja registrado el resultado del corte.
